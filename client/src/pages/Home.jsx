      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <br />
         ...
         <div className='text-gray-400 text-xs sm:text-sm'>
          Ease Estate is the best place to find your next perfect place to live
          <br />
          We have a wide range of properties for youto choose from.
         </div>
        ...
        {rentListings && rentListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-blue-800 text-sm hover:underline' to={'/search?type=rent'}> Show more places for rent</Link>
...
{saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-blue-800 text-sm hover:underline' to={'/search?type=sale'}> Show more places for sale</Link>
